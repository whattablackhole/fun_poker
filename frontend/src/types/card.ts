...
// @generated from protobuf file "card.proto" (syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message Card
 */
export interface Card {
    /**
     * @generated from protobuf field: CardValue value = 1;
     */
    value: CardValue;
    /**
     * @generated from protobuf field: CardSuit suit = 2;
     */
    suit: CardSuit;
}
/**
 * @generated from protobuf message CardPair
 */
export interface CardPair {
    /**
     * @generated from protobuf field: Card card1 = 1;
     */
    card1?: Card;
    /**
     * @generated from protobuf field: Card card2 = 2;
     */
    card2?: Card;
}
/**
 * @generated from protobuf enum CardValue
 */
...
/**
 * @generated from protobuf enum CardSuit
 */
...
class Card$Type extends MessageType<Card> {
    constructor() {
        super("Card", [
            { no: 1, name: "value", kind: "enum", T: () => ["CardValue", CardValue] },
            { no: 2, name: "suit", kind: "enum", T: () => ["CardSuit", CardSuit] }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Card): Card {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* CardValue value */ 1:
                    message.value = reader.int32();
                    break;
                case /* CardSuit suit */ 2:
...
/**
 * @generated MessageType for protobuf message Card
 */
...
/**
 * @generated MessageType for protobuf message CardPair
 */
