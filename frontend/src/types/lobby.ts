...
/**
 * @generated from protobuf message lobby.Lobby
 */
export interface Lobby {
    ...
    gameType: GameType;
    /**
     * @generated from protobuf field: lobby.GameName game_name = 6;
     */
    gameName: GameName;
}
/**
 * @generated from protobuf message lobby.LobbyList
 */
export interface LobbyList {
    /**
     * @generated from protobuf field: repeated lobby.Lobby list = 1;
     */
    list: Lobby[];
}
/**
 * @generated from protobuf enum lobby.GameName
 */
...
/**
 * @generated from protobuf enum lobby.GameType
 */
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* lobby.GameType game_type */ 5:
                    ...
                    break;
                case /* lobby.GameName game_name */ 6:
...
class LobbyList$Type extends MessageType<LobbyList> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LobbyList): LobbyList {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated lobby.Lobby list */ 1:
...
/**
 * @generated MessageType for protobuf message lobby.LobbyList
 */
